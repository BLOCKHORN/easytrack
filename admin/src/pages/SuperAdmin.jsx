    ...
    <div className={`sa ${sidebarOpen ? 'is-sidebar-open' : ''}`}>
      ...
      <header className="sa__topbar">
        ...
        <div className="sa__right">
          ...
          <button className="btn" onClick={() => supabase.auth.signOut()}><Icon name="logout" />Salir</button>
        </div>
      </header>
            ...
            <div className="sa__panel">
              ...
              {tab === 'users' && (
                <section className="card">
                  ...
                  <p className="muted">La impersonación abre un magic-link en una pestaña nueva.</p>
                </section>
              )}
