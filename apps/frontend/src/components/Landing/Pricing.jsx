...
const IconSparkles = () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-brand-400"><path d="m12 3-1.912 5.813a2 2 0 0 1-1.275 1.275L3 12l5.813 1.912a2 2 0 0 1 1.275 1.275L12 21l1.912-5.813a2 2 0 0 1 1.275-1.275L21 12l-5.813-1.912a2 2 0 0 1-1.275-1.275L12 3Z"/><path d="M5 3v4"/><path d="M19 17v4"/><path d="M3 5h4"/><path d="M17 19h4"/></svg>;
...
export default function Pricing() {
  ...
  return (
    <section id="pricing" className="relative bg-white pt-24 pb-40 px-4 overflow-hidden border-t border-zinc-200 font-sans">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-[500px] bg-[radial-gradient(circle,rgba(99,102,241,0.03)_0%,transparent_70%)] pointer-events-none" />
      ...
      <div className="relative max-w-7xl mx-auto z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch mb-20">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-white p-8 md:p-10 rounded-[2rem] border border-zinc-200 flex flex-col justify-between hover:border-zinc-300 transition-colors shadow-sm">
            <div>
              ...
              <p className="text-zinc-500 font-medium mb-8 text-sm">Prueba el sistema sin riesgo.</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0"><IconCheck /></div><p className="font-bold text-zinc-700 text-sm">Importación masiva inicial (IA)</p></div>
                ...
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0 text-zinc-300"><IconLock /></div><p className="font-bold text-zinc-400 text-sm line-through">Avisos WhatsApp al cliente</p></div>
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0 text-zinc-300"><IconLock /></div><p className="font-bold text-zinc-400 text-sm line-through">Control de empleados</p></div>
                                <div className="flex items-start gap-3"><div className="mt-1 shrink-0 text-zinc-300"><IconLock /></div><p className="font-bold text-zinc-400 text-sm line-through">Área de facturación</p></div>
          ...
          {/* PLUS */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-white p-8 md:p-10 rounded-[2rem] border-2 border-brand-500 flex flex-col justify-between relative shadow-xl shadow-brand-500/10">
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-brand-500 text-white px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm">Recomendado</div>
            <div>
              <h3 className="text-xl font-black text-zinc-900 mb-2 tracking-tight">Plus</h3>
              <p className="text-zinc-500 font-medium mb-8 text-sm">Para locales consolidados.</p>
              <div className="mb-8 h-16 flex items-end gap-1"><span className="text-5xl font-black text-zinc-950 tracking-tighter leading-none">{isAnnual ? '199€' : '19,90€'}</span><span className="text-zinc-500 font-bold mb-1 pb-0.5">/ {isAnnual ? 'año' : 'mes'}</span></div>
              <div className="space-y-4">
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0"><IconCheck /></div><p className="font-bold text-zinc-700 text-sm">Paquetes ilimitados</p></div>
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0"><IconCheck /></div><p className="font-bold text-zinc-700 text-sm">Notificaciones integradas (WhatsApp)</p></div>
          ...
          {/* PRO */}
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-zinc-950 p-8 md:p-10 rounded-[2rem] border border-zinc-800 flex flex-col justify-between relative shadow-xl">
            <div className="relative z-10">
              <h3 className="text-xl font-black text-white mb-2 tracking-tight">PRO</h3>
              <p className="text-zinc-400 font-medium mb-8 text-sm">Control absoluto y velocidad.</p>
              <div className="mb-8 h-16 flex items-end gap-1"><span className="text-5xl font-black text-white tracking-tighter leading-none">{isAnnual ? '399€' : '39,90€'}</span><span className="text-zinc-500 font-bold mb-1 pb-0.5">/ {isAnnual ? 'año' : 'mes'}</span></div>
              <div className="space-y-6">
                <div className="flex items-start gap-3"><div className="mt-1 shrink-0"><IconCheck /></div><p className="font-bold text-zinc-300 text-sm">Todo lo incluido en el plan Plus</p></div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-black text-white text-sm">Auditoría de Empleados</p>
                    <p className="text-xs text-zinc-400 mt-0.5 leading-relaxed">Cuentas independientes para el personal. Registra quién manipuló cada paquete.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-black text-white text-sm">Soporte Directo WhatsApp</p>
                    <p className="text-xs text-zinc-400 mt-0.5 leading-relaxed">Asistencia técnica B2B inmediata para que tu negocio nunca se detenga.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto text-center bg-zinc-50 border border-zinc-200 rounded-[2rem] p-10 md:p-12 shadow-sm">
          ...
          <p className="text-zinc-500 font-medium mb-8 text-lg leading-relaxed">Comienza en el plan Freemium importando tu stock actual sin compromiso. Podrás mejorar tu infraestructura desde tu panel de control a medida que tu volumen de negocio crezca.</p>
