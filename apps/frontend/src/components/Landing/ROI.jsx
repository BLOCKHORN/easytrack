...
export default function ROI() {
  ...
  return (
    <section className="relative bg-zinc-950 text-white pb-32 pt-20 lg:pb-48 overflow-hidden z-10">
      
      {/* Fondo optimizado estático */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[radial-gradient(circle,rgba(79,70,229,0.05)_0%,transparent_60%)] pointer-events-none" />
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          <div className="lg:w-7/12 flex flex-col gap-6">
            <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="group relative bg-zinc-900 border border-zinc-800 hover:border-brand-500/50 rounded-3xl p-8 md:p-10 transition-colors duration-300 shadow-xl">
            ...
            <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="group relative bg-zinc-900 border border-zinc-800 hover:border-emerald-500/50 rounded-3xl p-8 md:p-10 transition-colors duration-300 shadow-xl">
              <div className="flex flex-col sm:flex-row items-start gap-6 relative z-10">
            ...
            <motion.div variants={cardVariants} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="group relative bg-zinc-900 border border-zinc-800 hover:border-indigo-500/50 rounded-3xl p-8 md:p-10 transition-colors duration-300 shadow-xl">
              <div className="flex flex-col sm:flex-row items-start gap-6 relative z-10">
      ...
      {/* Ola Inferior (Transición perfecta a Testimonials que es slate-50) */}
