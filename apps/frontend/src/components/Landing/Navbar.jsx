                ...
                {(!checking && !tenantLoading) && (
                  isLoggedIn ? (
                    <div className="space-y-2">
                      ...
                      <button onClick={goConfig} className="w-full py-4 text-zinc-700 font-bold bg-zinc-100 hover:bg-zinc-200 rounded-xl flex justify-center items-center gap-2 transition-colors">
                        <IconSettings /> Configuración
                      </button>
