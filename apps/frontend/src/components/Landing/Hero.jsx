  ...
  return (
    <section className="relative pt-32 pb-40 md:pt-48 md:pb-48 bg-white overflow-hidden">
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none flex justify-center">
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-400/10 blur-[100px] pointer-events-none" />
        <div className="absolute top-[20%] right-[-10%] w-[40%] h-[60%] rounded-full bg-brand-500/10 blur-[100px] pointer-events-none" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100 border border-zinc-200 text-xs font-black text-zinc-600 uppercase tracking-widest mb-8"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-7xl lg:text-[80px] font-black tracking-tighter text-zinc-950 mb-8 leading-[1.05]"
          >
          ...
          <motion.p 
            ...
            className="text-lg md:text-2xl text-zinc-500 mb-12 max-w-3xl mx-auto font-medium leading-relaxed"
          >
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-20 w-full max-w-md"
          >
            <button 
          ...
          <motion.div 
            ...
            className="w-full pt-10 border-t border-zinc-100"
          >
