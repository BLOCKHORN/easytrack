                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                      <div className="bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <span className="text-3xl font-black text-zinc-950 tracking-tight">{formatEUR(d_ingresosMesActual)}</span>
                          <Delta value={d_deltaMoM} />
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <span className="text-3xl font-black text-zinc-950 tracking-tight">{formatEUR(d_ingresos30d)}</span>
                          <span className="text-[10px] font-bold text-zinc-400 mt-1">{d_entregas30d.toLocaleString()} entregas</span>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <span className="text-2xl font-black text-zinc-950 tracking-tight">{formatEUR(d_ticketMedioTotal)}</span>
                          <span className="text-[10px] font-bold text-zinc-400 mt-1">30d: {formatEUR(d_ticketMedio30d)}</span>
                        </div>
                      </div>
                      ...
                      <div className="bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-sm">
                        ...
                        <div className="flex flex-col gap-1">
                          <span className="text-xl font-black text-zinc-950 tracking-tight truncate">{d_empresas[0]?.empresa_transporte || "—"}</span>
                          <span className="text-[10px] font-bold text-zinc-400 mt-1">{(d_empresas[0]?.pct || 0).toFixed(1)}% cuota</span>
                        </div>
                      </div>
                    </div>
                          ...
                          {!editingGoal ? (
                            <div>
                              <div className="flex flex-col gap-1 mb-8">
                                <span className="text-5xl font-black text-white tracking-tight">{formatEUR(d_facturacionYTD)}</span>
                                <span className="text-sm font-bold text-zinc-500">de {formatEUR(d_objetivoAnual)}</span>
                              </div>
                              <div className="w-full bg-zinc-800/50 rounded-full h-4 backdrop-blur-md overflow-hidden relative">
                                <div className="bg-gradient-to-r from-brand-600 to-brand-400 h-full rounded-full relative transition-all duration-1000 ease-out" style={{ width: `${d_progresoObjetivo}%` }}>
                                  <div className="absolute inset-0 bg-white/20 w-full animate-[shimmer_2s_infinite]" />
                                </div>
                              </div>
                              <div className="mt-4 flex justify-between items-center">
                                <span className="text-sm font-bold text-brand-400">{d_progresoObjetivo}% completado</span>
                              </div>
                            </div>
                          ) : (
